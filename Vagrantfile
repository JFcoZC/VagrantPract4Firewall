...
Vagrant.configure("2") do |config|
    ...
    #Configurar en la interfaz privada y generada automaticamente por vagrant:
    #sudo iptables -A INPUT --in-interface enp0s8 -j ACCEPT
    #sudo iptables -A OUTPUT --out-interface enp0s8 -j ACCEPT
    #sudo iptables -A INPUT --in-interface enp0s3 -j ACCEPT
    #sudo iptables -A OUTPUT --out-interface enp0s3 -j ACCEPT
